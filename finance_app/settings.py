...
SECRET_KEY = 'django-insecure-9zi4-1wm+oooa^yth)1%!9uay-6s0cpq5h1(-*wamv^emr*-2*'
DEBUG = True
ALLOWED_HOSTS = []
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'api',  # Ensure 'api' exists inside your Django project
]
...
# If using a custom user model in `api/models.py`
AUTH_USER_MODEL = 'api.User'  # Ensure this matches your custom user model
